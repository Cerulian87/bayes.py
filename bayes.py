...
class Search():
    ...
    def sailor_final_location(self, num_search_areas):
        ...
        # Find sailor coordiantes with respect to any Search Area subarray.
...
def main():
    ...
    while True:
        ...
        if results_1 == 'Not Found' and results_2 == 'Not Found':
            ...
            cv.circle(app.img, (int(sailor_x), int(sailor_y)), 3, (255, 0, 0), -1)      # Had to change variables to int type
